...
class QuizPage extends StatefulWidget {
  const QuizPage(this.question, this.x, this.disorder, this.colors, {super.key});
...
class _QuestionState extends State<Question> {
  ...
  Future sendEmail(
    ...
    const serviceId = 'service_od7ysp6';
    const templateId = 'template_kpcxrxh';
    const userId = 'd74rFmdB8e9H76tx4';
    try {
                          ...
                          ? Container(
                              child: CircularPercentIndicator(
                                ...
                                progressColor: ans == widget.qno
                                    ?  const Color.fromARGB(255, 43, 193, 178)
                                    : ans >= widget.qno / 2
                                        ? Colors.orange
                                        : Colors.green,
                              ),
                        ...
                        setState(() {
                          ...
                          if (i > widget.qno - 1) {
                            ...
                            sendEmail(
                                ...
                                'Your patient has taken an ${widget.disorder} test. He/she has $risk risk of suffering through the disorder. Kindly share your advice on ${patientInfo.email} or contact him/her personally',
