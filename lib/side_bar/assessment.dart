                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              ...
                              7,
                              'Anxiety and stress',
                              const [ Color.fromARGB(255, 43, 193, 178), Colors.pinkAccent])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                ...
                onTap: () {
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(
                              pstd, 5, 'PTSD', const [Colors.cyan, Colors.teal])));
                },
              ),
              SizedBox(height: height / 60),
              InkWell(
                child: ListTile(
                  title: const Center(child: Text('Schizophrenia', style: style)),
                  tileColor: Colors.grey[100],
                  shape: RoundedRectangleBorder(
                    borderRadius: BorderRadius.circular(15),
                    side: const BorderSide(color: Colors.black, width: 1),
                  ...
                  Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => QuizPage(addiction, 6,
                              'Addiction', const [Colors.brown, Colors.blueGrey])));
                },
              ),
              SizedBox(height: height / 60),
            ],
